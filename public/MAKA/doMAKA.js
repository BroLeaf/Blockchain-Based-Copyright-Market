...
function newCard(cardUrl, val, condition) {
    ...
    k.innerHTML = k.innerHTML + "<div style='position:absolute;left:0;top:100;width:100%;height:100%;z-index=99999;background-color:#f1f1f1;text-align:center;'><center><div  style='width:560px;height:200px;border:3px; border-style:outset;background-color:#E6E6FA;'><br><br><br><a download='newCard.card' href="
                            + cardUrl +"><font size=4>如果沒有自動下載新Card，<br>請點擊這裡下載</font></a><br><br><br><br><br><a href='/'><font size=6 color=#FF5511>回首頁</font></a></div></center></div>";
}
